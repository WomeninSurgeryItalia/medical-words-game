        ...
        function() {
            ...
            var G = t(694),
             ...
             ie = ["golgi","aorta","apgar","vater","apnea","atomo","atono","gesso","globo","glomo","gocce","virus","vista","volto","vulva","zaffo","zecca","zinco","azoto","barba","bario","benda","bocca","borsa","botox","callo","calor","calvo","canto","carie","carpo","cauda","villi","chilo","chimo","chron","cieco","cisti","clamp","cloro","atrio","cocco","coito","colla","pessi","collo","colon","corde","corpo","corti","costa","covid","acaro","acido","acuto","adipe","afono","algia","alito","ameba","anche","angor","anite","chron","ansia","crema","cromo","cuore","dente","bulbo","derma","disco","dolor","dorso","dotto","duval","ebola","edema","elice","ellis","emesi","emina","enpam","ernia","etere","fasci","fiala","fibra","flebo","fobia","fovea","fresa","frova","fungo","galea","gamba","garza","gotta","acaro","gozzo","baffi","gusto","hnpcc","ictus","iodio","ioide","iride","istmo","fiato","krebs","kelly","lacci","imene","lasix","lembo","lenti","linfa","litio","lembo","logge","lombo","lupus","magro","meato","medio","mente","mesna","milza","mioma","miope","morbo","muffa","nervo","obeso","occhi","olier","mento","omero","osseo","ostio","otite","ovaio","ovulo","ozono","palmo","passo","parto","pelle","pelvi","peste","petto","piaga","picee","piede","piega","pinza","polpa","polso","pomfo","pompa","ponte","porta","potus","prono","psoas","punto","purga","quick","radio","raggi","retto","ritmo","ronco","rubor","sacca","sacro","salma","sella","sensi","sepsi","setto","shock","siero","sigma","sinus","sodio","soffi","solco","soleo","sonda","sordo","spore","stoma","suina","talco","tarso","tatto","tenar","tenia","tenue","testa","tibia","tigna","tinca","tosse","trago","tumor","turbe","udito","ugola","umano","umori","urato","urina","utero","valva","vasto"],
                ...
                de = function() {
                    var e = new Date("January 3, 2022 00:00:00").valueOf(),
                        a = Date.now(),
                        t = 864e5,
                        i = Math.floor((a - e) / t),
                        n = (i + 1) * t + e;
